...
/* harmony import */ var _checkNumInputs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./checkNumInputs */ "./src/js/modules/checkNumInputs.js");
 ...
 // Get all objects by which we get neccessery data
...
var changeModalState = function changeModalState(state) {
  ...
  Object(_checkNumInputs__WEBPACK_IMPORTED_MODULE_1__["default"])('#height'); // Get data from objects on page and put to single object, which in further would be sent to server
...
var modals = function modals() {
  function bindModal(triggerSelector, modalSelector, closeSelector) {
    ...
    var trigger = document.querySelectorAll(triggerSelector),
        ...
        windows = document.querySelectorAll('[data-modal]'),
        scroll = calcScroll(); // Open modal window by click
    ...
    }); // Close modal window by click on cross button
    ...
    }); // Close modal window by click on field abroad window
  ...
  } // Timer to open modal after 60 sec
  ...
  showModalByTime('#first_modal', 60000);
};
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  var header = document.querySelector(headerSelector),
      ...
      content = document.querySelectorAll(contentSelector); // Hide all tabs and content
  ...
  hideTabContent();
  showTabContent(); // Event listener for click on tabs to show choosen content
...
var timer = function timer(id, deadLine) {
  // Add '0' if time number consist of one digit
  var addZero = function addZero(num) {
    ...
    ;
  }; // Creates object in which stores time interval between deadline and present time.
  ...
  }; // Get divs with time and set time with every second updating.
  ...
  var setClock = function setClock(selector, endtime) {
    ...
    updateClock(); // To hide view changes when time set by HTML changes to time which we set by function in JS
